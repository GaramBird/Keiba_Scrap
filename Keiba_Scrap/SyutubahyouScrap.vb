...
Public Class SyutubahyouScrap
    Public Sub Scraping(syutubahyouurl)
        ...
        dt.Columns.Add("歳", GetType(String))
        dt.Columns.Add("毛色", GetType(String))
        dt.Columns.Add("斤量", GetType(String))
        dt.Columns.Add("騎手", GetType(String))
        dt.Columns.Add("オッズ", GetType(String))
        dt.Columns.Add("人気", GetType(String))
        dt.Columns.Add("1走前レース名", GetType(String))
        dt.Columns.Add("1走前長さ", GetType(String))
        dt.Columns.Add("1走前開催日", GetType(String))
        ...
        dt.Columns.Add("1走前順位", GetType(String))
        dt.Columns.Add("1走前タイム", GetType(TimeSpan))
        dt.Columns.Add("2走前レース名", GetType(String))
        dt.Columns.Add("2走前長さ", GetType(String))
        dt.Columns.Add("2走前開催日", GetType(String))
        ...
        dt.Columns.Add("2走前順位", GetType(String))
        dt.Columns.Add("2走前タイム", GetType(TimeSpan))
        dt.Columns.Add("3走前レース名", GetType(String))
        dt.Columns.Add("3走前長さ", GetType(String))
        dt.Columns.Add("3走前開催日", GetType(String))
        ...
        dt.Columns.Add("3走前順位", GetType(String))
        dt.Columns.Add("3走前タイム", GetType(TimeSpan))
        dt.Columns.Add("4走前レース名", GetType(String))
        dt.Columns.Add("4走前長さ", GetType(String))
        dt.Columns.Add("4走前開催日", GetType(String))
        ...
        dt.Columns.Add("4走前順位", GetType(String))
        dt.Columns.Add("4走前タイム", GetType(TimeSpan))
        dt.Columns.Add("5走前レース名", GetType(String))
        dt.Columns.Add("5走前長さ", GetType(String))
        dt.Columns.Add("5走前開催日", GetType(String))
        ...
        dt.Columns.Add("5走前順位", GetType(String))
